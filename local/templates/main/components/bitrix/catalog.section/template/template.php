...
{
	?>
	<div class="text-block wrapper bx-section-desc bx-<?=$arParams['TEMPLATE_THEME']?>">
...
<div class="catalog-section wrapper bx-<?=$arParams['TEMPLATE_THEME']?>" data-entity="<?=$containerName?>">
	<?
	if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS']))
	{
		...
		foreach ($arResult['ITEM_ROWS'] as $rowData)
		{
			...
			?>
			<div class="card__cont" data-entity="items-row">
				<?
					...
					case 7:
						...
						<div class="col-sm-6 product-item-small-card">
							<div class="row">
								...
								{
									?>
									<div class="col-xs-6 col-md-4">11
										<?
										$APPLICATION->IncludeComponent(
											'bitrix:catalog.item',
											'certificate',
					...
					case 8:
						...
						<div class="col-sm-6 product-item-small-card">
							<div class="row">
								...
								{
									?>
									<div class="col-xs-6 col-md-4">12
										<?
										$APPLICATION->IncludeComponent(
											'bitrix:catalog.item',
											'certificate',
...
{
	?>
	<div class="wrapper card__indent bx-<?=$arParams['TEMPLATE_THEME']?>">
		<div class="card__button-more" data-use="show-more-<?=$navParams['NavNum']?>">
