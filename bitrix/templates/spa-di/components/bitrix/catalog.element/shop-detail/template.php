...
$buyButtonClassName = in_array('BUY', $arParams['ADD_TO_BASKET_ACTION_PRIMARY']) ? 'btn-primary' : 'btn-primary';
$showAddBtn = in_array('ADD', $arParams['ADD_TO_BASKET_ACTION']);
$showButtonClassName = in_array('ADD', $arParams['ADD_TO_BASKET_ACTION_PRIMARY']) ? 'btn-primary' : 'btn-primary';
...
?>
<div class="bx-catalog-element shop-detail wrapper bx-<?=$arParams['TEMPLATE_THEME']?>" id="<?=$itemIds['ID']?>"
				...
				<div class="product-item-detail-slider-container" id="<?=$itemIds['BIG_SLIDER_ID']?>">
					...
					<div class="product-item-detail-slider-block
						...
						<div class="product-item-detail-slider-images-container" data-entity="images-container">
							<?php
                            if($actualItem["PREVIEW_PICTURE"]["SRC"]){
                                $actualItem['MORE_PHOTO']=[];
                                $actualItem['MORE_PHOTO'][]=$actualItem["PREVIEW_PICTURE"];
                            }
										...
										<div data-entity="main-button-container">
											<div id="<?=$itemIds['BASKET_ACTIONS_ID']?>" style="display: <?=($actualItem['CAN_BUY'] ? '' : 'none')?>;">
												...
												if ($showAddBtn)
												{
													?>
													<div class="product-item-detail-info-container">
														<a class="btn btn-primary product-item-detail-buy-button" id="<?=$itemIds['ADD_BASKET_LINK']?>"
												...
												<div class="product-item-detail-info-container">
													...
													$APPLICATION->IncludeComponent(
														...
														array(
															...
															'BUTTON_CLASS' => 'btn btn-lg btn-primary basket-btn-checkout',
