		...
		<div class="choose-block__content">
			...
			<div class="choose-block__info">
				...
				<div class="choose-block__bot">
							...
							<?foreach($arElement["PRICES"] as $code=>$arPrice):?>
								<?if($arPrice["CAN_ACCESS"]):?>
									<?if($arPrice["DISCOUNT_VALUE"] < $arPrice["VALUE"]):?>
										<s><?=$arPrice["PRINT_VALUE"]?></s> <span><?=$arPrice["PRINT_DISCOUNT_VALUE"]?></span>
									<?else:?>
					...
					<a class="choose-block__button" href="<?echo $arElement["ADD_URL"]?>" rel="nofollow"><?echo GetMessage("CATALOG_ADD")?></a>
					</noindex>
