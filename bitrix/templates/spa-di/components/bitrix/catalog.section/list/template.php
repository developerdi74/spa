...
<div class="card-content wrapper">
	...
	?>
		...
		<div class="card">
			<div class="card__img"><img src="<?=$arElement["PREVIEW_PICTURE"]["SRC"];?>" /></div>

			<div class="card_info">
				<div class="card__caption">Подарочный сертификат</div>
				<div class="card__title"><?=$arElement["NAME"];?> </div>
				<div class="card__desc"><?=$arElement["PREVIEW_TEXT"];?></div>
				...
				<div class="card__bottom">
					...
					<a class="card__button" href="<?echo $arElement["ADD_URL"]?>" rel="nofollow"><?echo GetMessage("CATALOG_ADD")?></a>
				</div>
			</div>
			
			<div class="card__detail"><?=$arElement["DETAIL_TEXT"];?></div>
		</div>	
<?endforeach;?>	
</div>
