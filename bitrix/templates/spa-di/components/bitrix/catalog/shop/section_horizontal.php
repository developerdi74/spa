...
*/
                ...
                <?
                $sort = isset($_GET["sort"])?$_GET["sort"]:"catalog_PRICE_1";
                $method = isset($_GET["method"])?$_GET["method"]:"ASC";
                $sortInvert = ($method == "ASC")?"DESC":"ASC";
                $asc = ($method=="ASC")?"&#8593;":"&#8595;";

                ?>
                <div class="shop-sort-section wrapper">
                    <span>Сортировка:</span>
                    <span>
                        <a class="<?=($sort=="catalog_PRICE_1")?'sort-active':'';?>" href="<?=$APPLICATION->GetCurPageParam("sort=catalog_PRICE_1&method=".$sortInvert,["sort","method"]);?>">
                            По цене <?=$asc?>
                        </a>
                    </span>
                    <span>
                        <a class="<?=($sort=="name")?'sort-active':'';?>" href="<?=$APPLICATION->GetCurPageParam("sort=NAME&method=".$sortInvert,["sort","method"]);?>">
                            По названию <?=$asc?>
                        </a>
                    </span>
                </div>
...
//Рекомендации
			if (ModuleManager::isModuleInstalled("sale") && 1==2)
			{
